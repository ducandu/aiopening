...
Quintus.UI = function(Q) {
  ...
  Q.UI.Text = Q.Sprite.extend("UI.Text", {
    ...
    calcSize: function() {
      ...
      this.p.w = this.p.w || metrics.width;
  ...
  Q.UI.Button = Q.UI.Container.extend("UI.Button", {
    init: function(p,callback) {
      this._super(Q._defaults(p,{
        type: Q._SPRITE_UI | Q._SPRITE_DEFAULT
      }));
  ...
  Q.UI.IFrame = Q.Sprite.extend("UI.IFrame", {
    init: function(p) {
      this._super(p, { opacity: 1, type: Q._SPRITE_UI | Q._SPRITE_DEFAULT });
  ...
  Q.UI.HTMLElement = Q.Sprite.extend("UI.HTMLElement", {
    init: function(p) {
      this._super(p, { opacity: 1, type: Q._SPRITE_UI  });
